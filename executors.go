...
func initExecutors() {
	...
	computation = New("computation-executor", Config{
		...
		BlockOnFullQueue:    env.Bool("EXECUTOR_COMPUTATION_BLOCK_ON_FULL_QUEUE", false),
	})
	...
	io = New("io-executor", Config{
		...
		BlockOnFullQueue:    env.Bool("EXECUTOR_IO_BLOCK_ON_FULL_QUEUE", false),
	})
	...
	single = New("single-executor", Config{
		...
		BlockOnFullQueue:    env.Bool("EXECUTOR_SINGLE_BLOCK_ON_FULL_QUEUE", false),
	})
}
